Coursera Data Science Capstone: Course Final assignment
========================================================
...
*[Github Repo]* - [https://github.com/antoraf/CourseraDataScienceFinalAssignment]
...
<span style="color:blue; font-weight:bold;font-size:0.7em">A Shiny application was developed based on the next word prediction model described previously as shown below. </span><img src="./www/FlowChart01.png"></img>
